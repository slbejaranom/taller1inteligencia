function [pesos, polarizacion, iteraciones] = entrenamiento(entradas, salidas, umbral_step, regla_aprendizaje, lr, porcentaje_errores)
...
%   
    ...
    aux = 0;    
    iteraciones = 0;
    while(aux < round(length(salidas)*porcentaje_errores))
